...
| `pr-tests.yml` | `.github/workflows/` | GitHub Actions workflow for PR tests |

## CI/CD

| Workflow | Trigger | Actions |
|----------|---------|---------|
| PR Tests | Pull requests to `main` | Checkout, Setup Java 21, Run `./gradlew test` |
...
| AWS SDK for Java v2 | 2.20.0 | S3 client for photo storage |
| Reactor Kotlin Extensions | (managed) | Kotlin extensions for Reactor |
| Jackson Kotlin Module | 2.18.3 | Kotlin-aware JSON serialization |
